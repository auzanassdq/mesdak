        ...
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              <input 
                className="bg-gray-100 rounded-full py-2 pl-4 pr-4 focus:outline-none focus:ring-2 focus:ring-[var(--forest-green)] w-48 transition-all" 
                placeholder="Search" 
                type="text"
                value={searchQuery}
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        >
          <div className="flex justify-center items-center mb-2">
            <h2 className="text-6xl text-center font-semibold text-gray-700">Welcome to M&apos;SuperDeal</h2>
          </div>
        </motion.div>
        ...
        >
          <div className="absolute bottom-0 left-0 p-10 text-white">
            <motion.h1 
              ...
              className="text-6xl font-bold mb-10 text-[var(--vibrant-orange)]"
            >
