    ...
    <div className="font-display bg-background-light dark:bg-background-dark text-slate-800 dark:text-slate-200">
      ...
      <div className="relative flex w-full flex-col group/design-root overflow-x-hidden">
        <div className="flex h-full grow flex-col">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between">
                ...
                <div className="hidden md:flex flex-1 justify-end gap-6 items-center">
                  ...
                  <button className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-6 bg-white text-slate-900 hover:bg-slate-200 text-sm font-bold transition-colors">
          ...
          {/* Hero */}
          <main>
            <div className="relative min-h-screen flex flex-col items-center justify-center text-center text-white p-4 hero-bg bg-cover bg-center">
              <div className="max-w-3xl">
                ...
                <p className="mt-6 text-base sm:text-lg text-slate-300 max-w-2xl mx-auto">
                  MSME Network Incorporation is the operating firm behind
                  M&apos;Network, a unified digital ecosystem connecting
                  individuals and organizations for collaboration, visibility,
                  and growth.
                </p>
                <button className="mt-8 flex mx-auto min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-8 bg-primary hover:bg-primary-700 text-white text-base font-bold transition-colors">
                ...
                <section className="flex flex-col gap-10 px-4 sm:px-6 lg:px-8 py-16 md:py-24 @container">
                  <div className="flex flex-col gap-4 text-center items-center">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-base md:text-lg leading-relaxed max-w-3xl">
                      Our mission is to connect a diverse range of
                      individuals—from students and professionals to
                      retirees—with organizations of all scales, including
                      micro-enterprises, large corporations, financial
                      institutions, and government bodies. We foster an
                      environment ripe for collaboration, enhanced visibility,
                  ...
                  <div className="max-w-7xl mx-auto w-full">
                    <div className="flex flex-col gap-4 max-w-3xl">
                      ...
                      <p className="text-slate-600 dark:text-slate-400 text-base md:text-lg leading-relaxed">
                        ...
                        data-driven service solutions designed to empower your
                        organization at every stage of its journey.
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mt-12">
                      ...
                      <div className="flex flex-col gap-3 rounded-xl bg-background-light dark:bg-slate-800 p-6 shadow-sm">
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          <p className="text-slate-600 dark:text-slate-400 text-sm">
                            Establish a powerful brand presence and foster
                            community.
                          </p>
                        </div>
                        <ul className="mt-3 space-y-2 text-sm text-slate-600 dark:text-slate-400">
                          <li className="flex items-center gap-2">
                            <span className="material-symbols-outlined !text-base text-primary-500">
                              check_circle
                            </span>{" "}
                      ...
                      <div className="flex flex-col gap-3 rounded-xl bg-background-light dark:bg-slate-800 p-6 shadow-sm">
                        ...
                        <div className="flex flex-col gap-1">
                          <h3 className="text-slate-900 dark:text-slate-100 text-lg font-semibold">
                            Activate Engagement &amp; Reach
                          </h3>
                          <p className="text-slate-600 dark:text-slate-400 text-sm">
                            Drive sales growth and validate your products with
                            the right audience.
                          </p>
                        </div>
                        <ul className="mt-3 space-y-2 text-sm text-slate-600 dark:text-slate-400">
                      ...
                      <div className="flex flex-col gap-3 rounded-xl bg-background-light dark:bg-slate-800 p-6 shadow-sm">
                        ...
                        <div className="flex flex-col gap-1">
                          <h3 className="text-slate-900 dark:text-slate-100 text-lg font-semibold">
                            Scale Markets &amp; Expand
                          </h3>
                          <p className="text-slate-600 dark:text-slate-400 text-sm">
                            Navigate new territories and grow your market
                      ...
                      <div className="flex flex-col gap-3 rounded-xl bg-background-light dark:bg-slate-800 p-6 shadow-sm">
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          <p className="text-slate-600 dark:text-slate-400 text-sm">
                            Build a strong foundation with the right talent and
                            strategic guidance.
                          </p>
                        </div>
                        <ul className="mt-3 space-y-2 text-sm text-slate-600 dark:text-slate-400">
                          ...
                          <li className="flex items-center gap-2">
                            ...
                            Company Building &amp; Venture Studio
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="material-symbols-outlined !text-base text-primary-500">
                              check_circle
          ...
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="col-span-2 md:col-span-1">
                ...
                <p className="text-sm">
                  Connecting individuals and organizations for collaboration,
                  visibility, and growth.
                </p>
              </div>

              <div>
                <h4 className="font-semibold text-sm text-slate-200 mb-4">
                  Company
                </h4>
      ...
      <style jsx>{`
        ...
        .hero-bg {
          background-image: linear-gradient(
            ...
            url("https://lh3.googleusercontent.com/aida-public/AB6AXuASTbX70Wmbibb-b4mwzOPWOOQji53ee7Chn33MiP_v_N6UcWd4Z5e4HTygnp1ZYazsbC_o9o0t-DHWl2-Z-QSMOImtPOdAe7X14_3IOx866zRH1dSMd6aEr09vRAiB3a_CGuUCP74FeOe0b04WhnULiZ4ODtFAYqOjI7957dv-C2QDCIoUop__NRaX97muaHSYbyscStQVFZ3xbTY_cj93R_Gg2uohKzc6Qlz-hP7BJrHYx0JrvXcTn0dAwOGTKxX6hDGJvRR1z5nw");
        }
      `}</style>
    </div>
  );
