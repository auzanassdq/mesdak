...
import { BuildingIcon, CaretDownIcon, CaretRightIcon, ClockIcon, MapPinIcon, TrendUpIcon, UserCheckIcon, UsersIcon } from '@phosphor-icons/react/dist/ssr';
    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="py-8 lg:py-2">
              <p className="text-3xl text-black leading-relaxed text-justify font-medium">
                <span className='bg-primary-400 inline p-2'>
                  Experienced professionals, lead innovation in MSMEs development. 
                </span>
                 No traditional job descriptions needed. Share your game-changing ideas and shape the future of MSMEs.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-28 bg-gray-100">
        <div className="container mx-auto px-6">
          ...
          >
            <h3 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
                {locations.map((location) => (
                  <motion.div
                    ...
                    className={`bg-white border-2 p-3 hover:bg-primary hover:text-white group transition-all duration-300 cursor-pointer ${
